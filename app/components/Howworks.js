        ...
        <section className="py-20 bg-white">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="text-center mb-16">
                    <div className="inline-flex items-center gap-2 bg-gradient-to-r from-pink-500 to-purple-600 text-black px-6 py-2 rounded-full text-sm font-medium mb-6">
                ...
                <div className="mt-20 grid md:grid-cols-3 gap-8 hidden lg:grid">
                    <div className="text-center">
                        ...
                        <h4 className="text-3xl font-bold text-black mb-2">10,000+</h4>
                    ...
                    <div className="text-center">
                        ...
                        <h4 className="text-3xl font-bold text-black mb-2">$2M+</h4>
